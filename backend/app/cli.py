...
def main(argv: Optional[List[str]] = None) -> None:
    ...
    s2.add_argument("--model-family", choices=["auto", "baseline", "sklearn_gbdt", "legacy_boosted", "lightgbm", "xgboost", "catboost"], default="auto", help="Model family to train. legacy_boosted recreates the older RandomForest + GradientBoosting style. auto compares all installed candidates.")
