...
import type { Announcement, HistoricalDataPoint, PredictionCardData, Stock, StockResources } from "../../lib/api/types";
...
export function StockDetail() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const [historyData, predictionData, announcementData, resourceData] = await Promise.all([
