...
import type { Announcement, HistoricalDataPoint, PredictionCardData, SentimentSummary, Stock, StockResources } from "../../lib/api/types";
...
export function StockDetail() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const [historyData, predictionData, announcementData, resourceData, sentimentData] = await Promise.all([
